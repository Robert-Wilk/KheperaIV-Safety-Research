...
# from https://github.com/robotarium/robotarium-python-simulator/blob/812f9ed479288049a39ddb75c4c9013bf531d5a2/robotarium/transformations.py


def barrier_certificate(dxi, x, dx_max=.1, ds=0.08):
...
def int_to_uni2(dxi, states, kv=0.75, kw=np.pi):
    """
    Parameters
    ----------
    dxi :
